...
AC_DEFUN([_MSU_LOG_LEVEL_CHECK_VALUE],
[
	AS_CASE($1,
...
[
	...
	do
		IFS=${old_IFS}
		_MSU_LOG_LEVEL_CHECK_VALUE([$log_level])
		IFS=","
	...
	AC_DEFINE_UNQUOTED([MSU_LOG_LEVEL], [${LOG_LEVEL}], [Log level flag for debug messages])

	AC_MSG_RESULT([ok])
]
)

AC_DEFUN([MSU_LOG_TYPE_CHECK],
[
	...
	AC_DEFINE_UNQUOTED([MSU_LOG_TYPE], [$1], [Define log output technolgy])
