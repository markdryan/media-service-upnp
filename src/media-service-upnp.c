...
static const gchar g_msu_server_introspection[] =
	...
	"       access='read'/>"
	"    <property type='a{sv}' name='"MSU_INTERFACE_PROP_SV_DLNA_CAPABILITIES"'"
	"       access='read'/>"
	"    <property type='as' name='"MSU_INTERFACE_PROP_SV_SEARCH_CAPABILITIES"'"
	"       access='read'/>"
	"    <property type='as' name='"MSU_INTERFACE_PROP_SV_SORT_CAPABILITIES"'"
	"       access='read'/>"
	"    <property type='as' name='"MSU_INTERFACE_PROP_SV_SORT_EXT_CAPABILITIES"'"
	"       access='read'/>"
	"    <property type='u' name='"MSU_INTERFACE_PROP_ESV_SYSTEM_UPDATE_ID"'"
	"       access='read'/>"
	"    <property type='s' name='"MSU_INTERFACE_PROP_ESV_SERVICE_RESET_TOKEN"'"
	"       access='read'/>"
