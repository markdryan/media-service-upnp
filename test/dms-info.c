...
#define DMS_INFO_SERVICE "com.intel.media-service-upnp"
#define DMS_INFO_MANAGER_IF "com.intel.MediaServiceUPnP.Manager"
#define DMS_INFO_MANAGER_OBJ "/com/intel/MediaServiceUPnP"
...
int main(int argc, char *argv[])
{
	...
	/* Create proxy for com.intel.MediaServiceUPnP.Manager.  The Manager
	...
	the proxy will force media-service-upnp be to launched if it is not
	already running. */
